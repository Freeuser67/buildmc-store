        ...
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Button 
              type="button" 
              variant="outline" 
              className="w-full h-12 gap-3 text-base font-semibold border-2 border-[#5865F2]/30 hover:border-[#5865F2]/60 hover:bg-[#5865F2]/10 transition-all group opacity-50 cursor-not-allowed"
              disabled
              title="Discord login coming soon"
            >
              <svg className="w-5 h-5 text-[#5865F2]/50" viewBox="0 0 24 24" fill="currentColor">
